<?php
if ( ! class_exists( 'myCRED_Pacman_License' ) ) :
	final class myCRED_Pacman_License {

		// Plugin Version
		public $version = MYCRED_PACMAN_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_PACMAN_SLUG;

		public $base    = MYCRED_PACMAN;
...
function mycred_pacman_license() {
	return myCRED_Pacman_License::instance();
}
mycred_pacman_license();