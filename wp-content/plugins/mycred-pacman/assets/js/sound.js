var EATING_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/eating.mp3" 
]);
var GHOST_EATEN_SOUND = new buzz.sound([
	sounds.pluginsurl+"/assets/sound/ghost-eaten.mp3" 
]);
var EXTRA_LIFE_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/extra-life.mp3" 
]);
var EAT_PILL_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/eat-pill.mp3" 
]);
var EAT_FRUIT_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/eat-fruit.mp3" 
]);
var EAT_GHOST_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/eat-ghost.mp3" 
]);
var SIREN_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/siren.mp3" 
]);
var WAZA_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/waza.mp3" 
]);
var READY_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/ready.mp3" 
]);
var DIE_SOUND = new buzz.sound([
    sounds.pluginsurl+"/assets/sound/die.mp3" 
]);
...
function isAvailableSound() { 
	return !(jQuery("#pacman_id_sound").css("display") === "none");
}
