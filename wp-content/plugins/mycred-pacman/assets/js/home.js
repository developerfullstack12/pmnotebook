...
function initHome() { 
	...
	jQuery("#pacman_panel").hide();
	jQuery("#pacman_home").show();
	jQuery("#pacman_home h3 em").append( " - " + new Date().getFullYear() );
...
function startPresentation() { 
	jQuery("#pacman_presentation *").hide();
...
function nextSequencePresentation() { 
	if (HOME_PRESENTATION_STATE === 0) { 
		jQuery("#presentation-titles").show();
	} else if (HOME_PRESENTATION_STATE === 2) { 
		jQuery("#canvas-presentation-blinky").show();
	} else if (HOME_PRESENTATION_STATE === 4) { 
		jQuery("#presentation-character-blinky").show();
	} else if (HOME_PRESENTATION_STATE === 5) { 
		jQuery("#presentation-name-blinky").show();
	} else if (HOME_PRESENTATION_STATE === 6) { 
		jQuery("#canvas-presentation-pinky").show();
	} else if (HOME_PRESENTATION_STATE === 8) { 
		jQuery("#presentation-character-pinky").show();
	} else if (HOME_PRESENTATION_STATE === 9) { 
		jQuery("#presentation-name-pinky").show();
	} else if (HOME_PRESENTATION_STATE === 10) { 
		jQuery("#canvas-presentation-inky").show();
	} else if (HOME_PRESENTATION_STATE === 12) { 
		jQuery("#presentation-character-inky").show();
	} else if (HOME_PRESENTATION_STATE === 13) { 
		jQuery("#presentation-name-inky").show();
	} else if (HOME_PRESENTATION_STATE === 14) { 
		jQuery("#canvas-presentation-clyde").show();
	} else if (HOME_PRESENTATION_STATE === 16) { 
		jQuery("#presentation-character-clyde").show();
	} else if (HOME_PRESENTATION_STATE === 17) { 
		jQuery("#presentation-name-clyde").show();
	}
...
function startTrailer() { 
	...
	var canvas = document.getElementById('pacman_trailer');
