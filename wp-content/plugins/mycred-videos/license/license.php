<?php
if ( ! class_exists( 'myCRED_Video_License' ) ) :
	final class myCRED_Video_License {

		// Plugin Version
		public $version = MYCRED_VIDEO_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_VIDEO_SLUG;

		public $base    = MYCRED_VIDEO;
...
function mycred_video_license() {
	return myCRED_Video_License::instance();
}
mycred_video_license();