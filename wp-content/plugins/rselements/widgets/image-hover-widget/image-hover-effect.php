...
class Rsaddon_pro_Image_Hover_Effect_Widget extends \Elementor\Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
            'media_padding',
            [
                'label' => esc_html__( 'Image or Icon Padding', 'rsaddon' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .image-content .effect-icons' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        ); 
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-image-hover-effect .effect-icons.tops' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-image-hover-effect .effect-icons.tops' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rs-image-hover-effect .effect-icons.tops'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .effect-icon i' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'icon_type' => 'icon'
                ]
        ...
        $this->add_responsive_control(
            'image_box_size',
            [
                'label' => esc_html__( 'Icon or Image Box Width', 'rsaddon' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-image-hover-effect .effect-icons.tops' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'icon_position' => 'tops'
                ]
        ...
        $this->add_responsive_control(
            'image_box_height',
            [
                'label' => esc_html__( 'Icon or Image Box Height', 'rsaddon' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-image-hover-effect .effect-icons.tops' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'icon_position' => 'tops'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-image-hover-effect .effect-icons.tops' => 'top: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .effect-icon img' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'icon_type' => 'image'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .effect-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'icon_type' => 'icon'
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        '{{WRAPPER}} .rs-image-hover-effect .image-content' => 'text-align: {{VALUE}}',
                        '{{WRAPPER}} .rs-image-hover-effect .image-part' => 'text-align: {{VALUE}}',
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .rs-image-hover-effect .prefix-part .title-prefix' => 'color: {{VALUE}}',
                    ],
                    'condition' => [
                        'show_prefix' => 'yes',
                    ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .rs-image-hover-effect:hover .prefix-part .title-prefix' => 'color: {{VALUE}}',
                    ],
                    'condition' => [
                        'show_prefix' => 'yes',
                    ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .rs-image-hover-effect .prefix-part .title-prefix' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    ],
                    'condition' => [
                        'show_prefix' => 'yes',
                    ],
                ...
                <?php if(!empty($settings['show_image_content'])) : ?>
                    <div class="image-content">
                        <?php if( !empty($settings['selected_icon']) || !empty($settings['selected_image']['url'])){?>
                            <div class="effect-icons <?php echo wp_kses_post($settings['icon_position']);?>">
                        ...
                        <?php if(!empty($settings['image_title'])){ ?>
                            ...
                            <?php if(!empty($settings['image_btn_text'])){?>
                                <div class="button-part <?php echo wp_kses_post($settings['btns_styles']);?>">
                                    <?php 
                                        $btn_icon_position = $settings['image_btn_icon_position'] == 'before' ? 'icon-before' : 'icon-after';
                                    ?>
                                    <a class="btn-text image-btn <?php echo esc_html($btn_icon_position); ?>" href="<?php echo esc_url($settings['btn_link']['url']);?>" <?php  echo wp_kses_post($this->print_render_attribute_string( 'image_btn_text' )); ?>>             
