	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-team team-slider-style6 .team-name a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-item .content-part .name a' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-team team-slider-style6 .team-name a:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-item .content-part .name a:hover' => 'color: {{VALUE}};',
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .team-item .content-part .name',
                     ...
                     '{{WRAPPER}} .rs-team team-slider-style6 .team-name'
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-team team-slider-style6 .team-title' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-item .content-part .designation' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-slider-style4 .team-item .team-content .team-title' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-slider-style5 .team-inner-wrap .team-content .team-title' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-slider-style1 .team-item:after' => 'background: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-item .content-part .social-links li a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .social-icons1 a i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .social-icons a i' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-item .content-part .social-links li a:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .social-icons1 a i:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .social-icons a i:hover' => 'color: {{VALUE}};',
