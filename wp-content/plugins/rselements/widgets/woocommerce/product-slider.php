...
class Rsaddon_Elementor_Pro_Product_Slider_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'RS Woo Porduct Slider', 'rsaddon' );
	}
	...
	protected function _register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .rselements-product-list' => 'text-align: {{VALUE}}'
                ],                
                'separator' => 'before',                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rselements-product-list' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'rs_product_grid_product_title_hover_color',
            [
                'label' => esc_html__('Product Title Hover Color', 'rsaddon'),
                'type' => Controls_Manager::COLOR,
                'default' => '#272727',
                'selectors' => [
                    '{{WRAPPER}} .rselements-product-list h4 a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .product-btn a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
            	...
            	<div class="product-item">
	                <div class="product-img overlay">
                        ...
                        <div class="product-btn">
                            <?php educavo_wc_add_to_cart_icon();?>
                        </div>
	                </div>
