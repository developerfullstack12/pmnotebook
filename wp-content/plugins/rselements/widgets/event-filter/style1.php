		    ...
		    <div class="content-part">
		    	...
		    	<?php if(!empty($settings['add_event']) || !empty($settings['tim_event'])) { ?>
		    		<div class="time-secs">
					    ...
					    <div class="time"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo esc_attr($ev_start_time);?><?php echo '-' ?><?php echo esc_attr($ev_end_time);?> </div>
						<?php } ?>
					</div>
				<?php } ?>
		        ...
		        <?php if(!empty($settings['show_meta']) || !empty($settings['show_btn'])) { ?>
			        <div class="event-btm">
				        <?php if(!empty($settings['show_meta'])) { ?>
				            <div class="date-part">
				                <div class="date">
				                	<i class="fa fa-calendar-check-o"></i> <?php echo esc_attr($start_date);?>  
				                </div>
				            </div>
				        <?php } ?>
