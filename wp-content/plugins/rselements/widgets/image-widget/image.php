...
class Rsaddon_pro_Image_Showcase_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [                  
                    ...
                    'veritcal_two' => esc_html__( 'Veritcal 2', 'rsaddon'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'image_animation' => 'yes',
                    'images_translate' => ['veritcal', 'veritcal_two']
                ],
            ]
        );  
    ...
    protected function render() {
        ...
        <?php        
            if(!empty($settings['rs_image_animate_start_x']['size'])&&['rs_image_animate_start_x']['unit']) : 
                $start   = $settings['rs_image_animate_start_x']['size'].$settings['rs_image_animate_start_x']['unit']; 
            endif;
            if(!empty($settings['rs_image_animate_end_x']['size'])&&['rs_image_animate_end_x']['unit']) : 
                $end     = $settings['rs_image_animate_end_x']['size'].$settings['rs_image_animate_end_x']['unit']; 
            endif; 
             if(!empty($settings['rs_image_animate_start_y']['size'])&&['rs_image_animate_start_y']['unit']) : 
                $start_y = $settings['rs_image_animate_start_y']['size'].$settings['rs_image_animate_start_y']['unit'];   
             endif;
             if(!empty($settings['rs_image_animate_end_y']['size'])&&['rs_image_animate_end_y']['unit']) : 
