...
class Rsaddon_Elementor_pro_Tutor_course_category_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'rs-course-category-tuttor';
	}		
	...
	public function get_title() {
		return __( 'RS Tutor Course Category', 'rsaddon' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,		      
		        'selectors' => [
		            '{{WRAPPER}} .rs-courses-categories .categories-item .content-part .courses-title' => 'color: {{VALUE}};',
		            '{{WRAPPER}} .rs-courses-categories .categories-item2 .title a' => 'color: {{VALUE}};',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,		      
		        'selectors' => [
		            '{{WRAPPER}} .rs-courses-categories .categories-item .content-part .courses' => 'color: {{VALUE}};',
		            '{{WRAPPER}} .rs-courses-categories .categories-item2 .course-qnty' => 'color: {{VALUE}};',
		...
		$this->add_control(
		    ...
		    [
				...
				'selectors' => ['{{WRAPPER}} .rs-courses-categories .categories-item .icon-part' => 'background: {{VALUE}};',],
			]
		);
		...
		$this->add_control(
		    ...
		    [
				...
				'selectors' => ['{{WRAPPER}} .rs-courses-categories .categories-item' => 'background: {{VALUE}};',],
			]
		);
		...
		$this->add_control(
		    ...
		    [
				...
				'selectors' => ['{{WRAPPER}} .rs-courses-categories .categories-item' => 'border-color: {{VALUE}};',],
			]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rs-courses-categories .categories-item2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rs-courses-categories .title, {{WRAPPER}} .rs-courses-categories .categories-item .content-part .courses-title, {{WRAPPER}} .rs-cate-slider.cate-slider-style4 .categories-items .cate-images .contents h3, {{WRAPPER}} .rs-cate-slider.cate-slider-style5 .categories-items .cate-images .contents h3, {{WRAPPER}} .rs-cate-slider .categories-items .cate-images .contents h3',
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'scheme' => Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .rs-courses-categories .course-qnty, {{WRAPPER}} .rs-courses-categories .courses, {{WRAPPER}} .rs-cate-slider .categories-items .cate-images .contents span, {{WRAPPER}} .rs-cate-slider.cate-slider-style4 .categories-items .cate-images .contents span, {{WRAPPER}} .rs-cate-slider.cate-slider-style5 .categories-items .cate-images .contents span',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,		      
		        'selectors' => [
		            '{{WRAPPER}} .rs-courses-categories .categories-item:hover .content-part .courses-title' => 'color: {{VALUE}};',
		            '{{WRAPPER}} .rs-courses-categories .categories-item2 .title a:hover' => 'color: {{VALUE}};',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,		      
		        'selectors' => [
		            '{{WRAPPER}} .rs-courses-categories .categories-item:hover' => 'color: {{VALUE}};',
		            '{{WRAPPER}} .rs-courses-categories .categories-item2 .course-qnty:hover' => 'color: {{VALUE}};',
		...
		$this->add_control(
		    ...
		    [
				...
				'selectors' => ['{{WRAPPER}} .rs-courses-categories .categories-item:hover .icon-part' => 'background: {{VALUE}};',],
			]
		);
		...
		$this->add_control(
		    ...
		    [
				...
				'selectors' => ['{{WRAPPER}} .rs-courses-categories .categories-item:hover' => 'background: {{VALUE}};',],
			]
		);
