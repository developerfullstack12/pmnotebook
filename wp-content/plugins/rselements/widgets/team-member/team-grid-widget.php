	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-grid-style1 .team-item .content-part .name a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-grid-style6 .team-item .team-content h3.team-name a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-grid-style2 .team-item .content-part .team-name a' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-grid-style1 .team-item .content-part .name a:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-grid-style6 .team-item .team-content h3.team-name a:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-grid-style2 .team-item:hover .content-part .team-name a' => 'color: {{VALUE}};',
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => 
                       '{{WRAPPER}} .team-grid-style1 .team-item .content-part .name, .team-grid-style6 .team-item .team-content h3.team-name a, .team-grid-style2 .team-item .content-part .team-name, .team-grid-style4 .team-item .team-content .team-name a, .team-grid-style5 .team-inner-wrap .team-content .member-desc .team-name a', 
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-grid-style2 .team-item .team-title' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .content-part .designation' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            'designation_st1_hover_color',
            [
                'label' => esc_html__( 'Designation Hover Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                	'team_grid_style' => 'style2',
                ],
                'selectors' => [
                    '{{WRAPPER}} .team-grid-style2 .team-item:hover .content-part .team-title' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
                     '{{WRAPPER}} .social-links li a i' => 'font-size: {{SIZE}}{{UNIT}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-grid-style5 .team-inner-wrap .team-content .social-icons a i, .team-grid-style6 .team-item .social-icons a i' => 'color: {{VALUE}};',
                ],
                'separator' => 'before',                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .social-links a i:hover' => 'color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .team-grid-style5 .team-inner-wrap .team-content .social-icons a:hover i,
                    .team-grid-style6 .team-item .social-icons a:hover i' => 'color: {{VALUE}};',
                ],
                'separator' => 'before',                
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-grid-style2 .team-item .content-part' => 'background: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Content Hover Background Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                	'team_grid_style' => ['style1', 'style2'],
                ],
                'selectors' => [
                    '{{WRAPPER}} .team-grid-style1 .team-item:after' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .team-grid-style2 .team-item:after' => 'background: {{VALUE}};',
