    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
         ...
         $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .testimonial-item .testimonial-information, .testimonial-content .testimonial-information' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
         ...
         $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .testimonial-item .item-content, .rs-testimonial .testimonial-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial .testimonial-item' => 'top: {{SIZE}}{{UNIT}};',
                ],
            ]
        ); 
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial .testimonial-item' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <div class="col-lg-<?php echo esc_html($settings['testimonial_columns']);?>  col-xs-1">
                                <div class="testimonial-item tstml <?php echo esc_attr( $settings['align'] );?>"> 
