...
class Rsaddon_Elementor_pro_Pricing_Table_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'_section_header',
			[
				'label' => esc_html__( 'Header Settings', 'rsaddon' ),
        ...
        $this->start_controls_section(
            '_section_icon',
            [
                'label' => esc_html__( 'Icon/Image Settings', 'rsaddon' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );        
        ...
        $this->start_controls_section(
            '_section_pricing',
            [
                'label' => esc_html__( 'Pricing Settings', 'rsaddon' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->start_controls_section(
            '_section_features',
            [
                'label' => esc_html__( 'Features Settings', 'rsaddon' ),
            ]
        );
        ...
        $this->start_controls_section(
            '_section_footer',
            [
                'label' => esc_html__( 'Footer Settings', 'rsaddon' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->start_controls_section(
            '_section_badge',
            [
                'label' => esc_html__( 'Badge Settings', 'rsaddon' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Period Style', 'rsaddon' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-price-table .rs-pricing-table-period::before' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
                    'pricing_inline' => 'display-inline'
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Features Style', 'rsaddon' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
