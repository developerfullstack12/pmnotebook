...
class Rsaddon_Elementor_pro_Course_Grid_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs_course_style1 .courses-item .img-part' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'course_grid_style' => '1',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs_course_style1 .courses-item .content-part' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'course_grid_style' => '1',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs_course_style1 .courses-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'course_grid_style' => '1',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style2 .course-wrap' => 'background: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style6 .courses-item .content-part .meta-part' => 'border-color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part .course-price span.price' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style6 .courses-item .img-part .course-price span.price' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style2 .course-wrap .price-btn span.price' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part .course-price span.price' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style6 .courses-item .img-part .course-price span.price' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style2 .course-wrap .price-btn a' => 'background: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part .meta-part li i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .courses-item .content-part .bottom-part .info-meta li' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style6 .courses-item .content-part .meta-part li' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style7 .courses-item .content-part .meta-part li' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style7 .courses-item .avatar-image' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style2 .course-wrap .price-btn a i:before' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style2 .course-wrap .price-btn a i:before' => 'background: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rs_course_style7 .courses-item .content-part',
                'condition' => [
                    'course_grid_style' => ['7'],
                ],
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '.rs_course_style7 .courses-item .content-part' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'course_grid_style' => ['7'],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item:hover .content-part .course-price span.price' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item:hover .content-part .course-price span.price' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style2 .course-wrap .price-btn a' => 'background: {{VALUE}};',
                ],                
            ]
        );       
	...
	protected function render() {
		...
		<div class="rs-courses rs_course_style<?php echo esc_attr($settings['course_grid_style']); ?>">	
			<div class="row grids">
					  <?php 	
						//Style One		
                                ...
                                <span class="price"><?php echo wp_kses_post($course->get_price_html()); ?></span>
                                        ...
                                        <?php if ( 'yes' === $settings['show_btms'] ){ ?>                                            
    	                                    <div class="bottom-part">
    	                                        ...
    	                                        <div class="info-meta">
    	                                            <ul>
    	                                                <li class="user"><i class="far fa-user"></i><?php echo $course_enroll_count; ?></li>
                                ...
                                <div class="inner-part">
                                    <div class="content-part">
                                        ...
                                        <ul class="course-meta">
                                            <li class="course-user"><i class="far fa-user"></i><?php echo $course_enroll_count; ?></li>
                                            <?php if(function_exists( 'learn_press_get_course_rate' )):?>
	                                            <li class="course-ratings">
	                                   				 <?php learn_press_course_review_template( 'rating-stars.php', array( 'rated' => $course_rate ) );?><div class="course-rating-total"> 
	                                   				 (<?php echo esc_html( $course_rate_total );?>)</div>
                            ...
                            <?php } ?>                                                           
                               ...
                               <?php if ($settings['show_dec'] == 'yes') : ?>
                                ...
                                <ul class="meta-part">
                                    ...
                                    <li class="user">
                                        <i class="far fa-user"></i><?php echo $course_enroll_count; ?> <?php echo esc_html__('Students', 'educavo');?>
                                    </li>                                    
                                </ul>
                            </div>
                        </div>
