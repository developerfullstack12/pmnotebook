...
class Rsaddon_Elementor_Pro_Learndash_Course_Grid_Widget extends \Elementor\Widget_Base {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part.e-style-5 span.price' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style3 .courses-item .content-part .course-price span.price' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part.e-style-5 span.price' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style3 .courses-item .content-part .course-price span.price' => 'background: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style3 .courses-item .content-part .meta-part li.cat a' => 'color: {{VALUE}};',
                ], 
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part.e-style-5 span.price:hover' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style2 .course-wrap .price-btn a:hover' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part.e-style-5 span.price:hover' => 'background: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs_course_style5 .courses-item .content-part .title a:hover' => 'color: {{VALUE}};',
                ],                
            ]
        );
	...
	protected function render() {
		...
		<div class="rs-courses e-dash-courses rs_course_style<?php echo esc_attr($settings['course_grid_style']); ?>">	
			<div class="row grids">
					  <?php 	
						//Style One		
