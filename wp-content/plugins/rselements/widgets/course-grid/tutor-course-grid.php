...
class Rsaddon_Elementor_pro_Tutor_Course_Grid_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'RS Tutor Course Grid', 'rsaddon' );
	}
                                ...
                                <div class="content-part">
                                        ...
                                        <li>
                                            <div class="course-price">
                                             <div class="tutor-course-loop-price">
                                                 <?php
                                                 $course_id = get_the_ID();
                                                 $price_html = '<span class="price">'.__('Free', 'rsaddon').'</span>';
                                    ...
                                    <?php if ( 'yes' === $settings['show_btms'] ){ ?> 
                                        <div class="bottom-part">
                                            <div class="info-meta">
                                                <ul>
                                                    <li class="user"><i class="far fa-user"></i><?php echo $course_students; ?></li>
                                ...
                                <div class="inner-part">
                                    <div class="content-part">
                                        ...
                                        <ul class="course-meta">
                                            <li class="course-user"><i class="far fa-user"></i><?php echo $course_students; ?></li>
                                            <li class="course-ratings">
                                               <?php $course_rating = tutor_utils()->get_course_rating();?>
                                                   <div class="course-rating-total"> 
                                                    <?php tutor_utils()->star_rating_generator($course_rating->rating_avg);?></div>
                           ...
                           <div class="courses-item">
                               ...
                               <div class="content-part">
                                    <ul class="meta-part">
                                        ...
                                        <li class="user">
                                            <i class="far fa-user"></i><?php echo $course_students; ?> <?php echo esc_html__('Students', 'educavo');?>
                                        </li>                                    
                                    </ul>                                                             
                                    <h3 class="title">
                                        <a href="<?php the_permalink();?>"><?php the_title();?></a>
