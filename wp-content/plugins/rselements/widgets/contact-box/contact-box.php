...
class Rsaddon_Elementor_pro_RScontactbox_Grid_Widget extends \Elementor\Widget_Base {
	 ...
	 */
		...
		$this->add_responsive_control(
            'box_width',
            [
                'label' => esc_html__( 'Icon Box Width', 'rsaddon' ),
		...
		$this->add_responsive_control(
            'box_height',
            [
                'label' => esc_html__( 'Icon Box Height', 'rsaddon' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-contact-box .address-item .address-icon i' => 'top: {{SIZE}}{{UNIT}}; position:absolute',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-contact-box .address-item .address-icon i' => 'left: {{SIZE}}%; position:absolute',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rs-contact-box .address-item.horizontal .address-icon' => 'border-color: {{VALUE}} !important',
		        ],
		    ]
		);
		...
		$this->start_controls_section(
		    '_section_des_style',
		    [
		        'label' => esc_html__( 'Address/Phone/Email', 'rsaddon' ),
		        'tab'   => Controls_Manager::TAB_STYLE,
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rs-contact-box .address-item .address-text .des:hover' => 'color: {{VALUE}} !important',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'des_typography',
				'selector' => '{{WRAPPER}} .rs-contact-box .address-item .address-text .des',
				'scheme' => Typography::TYPOGRAPHY_1,
			]
		);
			...
			?>
				<div class="address-item <?php echo esc_attr($settings['rs_contact_box_style']); ?>">
		            ...
		            <div class="address-icon">
		            	...
		            	<?php } else{ ?>
		            		<img src="<?php echo esc_html($item['selected_image']['url']); ?>" alt="<?php echo esc_html($item['selected_image']); ?>">
		            	<?php } ?>
		            </div>
		            <?php } ?>
		            ...
		            <div class="address-text">
		            	...
		            	<?php if(!empty($item['contact_label_phone'])){ ?>
			            	<div class="phone">
			            		...
			            		<span class="label"><?php echo esc_html($item['contact_label']);?></span>
			            		<?php } ?>
				                <a href="tel:<?php echo esc_html($item['contact_label_phone']);?>"><span class="des"><?php echo esc_html($item['contact_label_phone']);?></span></a>
				            </div>
			       		<?php } ?>
		            	...
		            	<?php if(!empty($item['contact_label_email'])){ ?>
			            	<div class="email">
			            		<?php if($item['contact_label']){ ?>
			            		 <span class="label"><?php echo esc_html($item['contact_label']);?></span>
			            		<?php } ?>
				                <a href="mailto:<?php echo esc_html($item['contact_label_email']);?>"><span class="des"><?php echo esc_html($item['contact_label_email']);?></span></a>
				            </div>
			       		<?php } ?>
