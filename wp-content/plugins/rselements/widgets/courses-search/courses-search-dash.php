...
class Rsaddon_Elementor_pro_RScourses_search_dash_Widget extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        <div class="rs-search-courses-addon">   
            <div class="rs-search">
                <form method="get" action="<?php echo esc_url( get_post_type_archive_link( 'sfwd-courses' ) ); ?>">
