...
final class Rsaddon_Elementor_Pro_Extension {
	...
	public function rsaddon_register_plugin_styles() {
        ...
        wp_enqueue_style( 'ddbeforeandafter', $dir.'assets/css/ddbeforeandafter.css' );  
        ...
        wp_enqueue_script( 'ddbeforeandafter', $dir.'assets/js/ddbeforeandafter.js', array('jquery'), '201513434', true);  
	...
	public function init_widgets() {
		...
		if ( class_exists( 'LearnPress' ) ) {			
			...
			require_once( __DIR__ . '/widgets/course-category-slider/category-slider-widget.php' );
			require_once( __DIR__ . '/widgets/courses-search/courses-search.php' );
		}

		if(class_exists( 'SFWD_LMS' )){
			require_once( __DIR__ . '/widgets/course-category/learndash-category.php' );
			require_once( __DIR__ . '/widgets/course-grid/learndash-course-grid.php' );
			require_once( __DIR__ . '/widgets/course-slider/learndash/course-slider-widget.php' );
			require_once( __DIR__ . '/widgets/course-category-slider/learndash/category-slider-widget.php' );
			require_once( __DIR__ . '/widgets/courses-search/courses-search-dash.php' );
		}


		if ( function_exists('tutor')) {
			require_once( __DIR__ . '/widgets/course-category/tutor-category.php' );
			require_once( __DIR__ . '/widgets/course-category-slider/tutor/category-slider-widget.php' );
			require_once( __DIR__ . '/widgets/course-grid/tutor-course-grid.php' );
			require_once( __DIR__ . '/widgets/courses-search/courses-search-tutor.php' );
		}
        ...
        require_once( __DIR__ . '/widgets/multi-image-widget/image.php' );
		...
		require_once( __DIR__ . '/widgets/latest-notice/latest-notice.php' );
		require_once( __DIR__ . '/widgets/circle-ripple/circle-ripple.php' );
		require_once( __DIR__ . '/widgets/newsletter/newsletter.php' );
		require_once( __DIR__ . '/widgets/event-slider/event-slider-widget.php' );
		require_once( __DIR__ . '/widgets/event-grid/event-grid-widget.php' );
		require_once( __DIR__ . '/widgets/event-filter/event-filter-widget.php' );
		require_once( __DIR__ . '/widgets/fancy-icon-text/rs-fancy-icon-text.php' );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_pro_Mulimage_hover_Widget() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Pro_thumbnail_slider_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Pro_blog_category_slider_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Pro_Blockquote_Widget());
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Image_Comparison_Pro_Widget() );
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Pro_Notice_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Pro_CircleRipple_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Events_Sliders_Pro_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Events_Grid_Pro_Widget() );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Events_Filter_Pro_Widget() );	
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_RSNewsLetter_Widget() );	
        
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_fancy_icons_Box_Widget() );	
        if ( class_exists( 'LearnPress' ) ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_cates_Slider_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_RScourses_search_Widget() );	
		}

		if(class_exists( 'SFWD_LMS' )){

			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_prold_Course_Category_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Pro_Learndash_Course_Grid_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Course_Slider_dash_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Cates_Ld_Slider_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_RScourses_search_dash_Widget() );
		}

		if ( function_exists('tutor')) {
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_Tutor_course_category_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Tutor_Category_Slider_Pro_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_Tutor_Course_Grid_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_RScourses_search_tutor_Widget() );
		}
