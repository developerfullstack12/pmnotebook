<?php
if ( ! class_exists( 'myCRED_Progress_Map_License' ) ) :
	final class myCRED_Progress_Map_License {

		// Plugin Version
		public $version = MYCRED_PROGRESS_MAP_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_PROGRESS_MAP_SLUG;

		public $base    = MYCRED_PROGRESS_MAP;
...
function mycred_progress_map_license() {
	return myCRED_Progress_Map_License::instance();
}
mycred_progress_map_license();