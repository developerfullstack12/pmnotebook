<?php
if ( ! class_exists( 'myCRED_Social_Share_License' ) ) :
	final class myCRED_Social_Share_License {

		// Plugin Version
		public $version = MYCRED_SOCIALSHARE_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_SOCIALSHARE_SLUG;

		public $base    = MYCRED_SOCIALSHARE_THIS;
...
function mycred_social_share_license() {
	return myCRED_Social_Share_License::instance();
}
mycred_social_share_license();