<?php
if ( ! class_exists( 'myCRED_PC_License' ) ) :
	final class myCRED_PC_License {

		// Plugin Version
		public $version = MYCRED_POINTS_CAP_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_POINTS_CAP_SLUG;

		public $base    = MYCRED_POINTS_CAP;
...
function mycred_pc_license() {
	return myCRED_PC_License::instance();
}
mycred_pc_license();