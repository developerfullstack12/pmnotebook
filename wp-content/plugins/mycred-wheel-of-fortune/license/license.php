...
if ( ! class_exists( 'myCRED_Wheel_Of_Fortune_License' ) ) :
	final class myCRED_Wheel_Of_Fortune_License {

		// Plugin Version
		public $version = MYCRED_WOF_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_WOF_SLUG;

		public $base    = MYCRED_WOF;
...
function mycred_wheel_of_fortune_license() {
	return myCRED_Wheel_Of_Fortune_License::instance();
}
mycred_wheel_of_fortune_license();