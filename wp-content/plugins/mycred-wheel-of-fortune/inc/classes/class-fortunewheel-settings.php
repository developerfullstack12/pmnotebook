        ...
        Container::make( 'post_meta', 'Wheel Settings' )
            ...
            ->add_tab( __('Form Fields'), array(
                ...
                Field::make( 'text', 'fortunewheel_cookie_expiry'.mycred_fortunewheel_crb_get_i18n_suffix(), 'Cookie Expiry Time' )
                    ->set_attribute('type','number')
                    ->set_default_value('2')
                    ->set_help_text('Expire Cookie Time in days (please enter 1 or greater number)'),
                ...
                Field::make( 'image', 'fortunewheel_wheel_center_logo'.mycred_fortunewheel_crb_get_i18n_suffix(), 'Wheel Center Logo' )
                    ->set_value_type( 'url' )
                    ->set_help_text( 'Add logo on center of the wheel' ),
                ...
                Field::make( 'checkbox', 'fortunewheel_enable_sparkle'.mycred_fortunewheel_crb_get_i18n_suffix(), 'Enable Sparkle' )
                    ->set_option_value( 'Enable Sparkle after win' ),
                ...
                Field::make( 'textarea', 'fortunewheel_daily_limit_exceed_msg'.mycred_fortunewheel_crb_get_i18n_suffix(), 'Limit Text' )
                    ->set_default_value('<div class="mc-limit-exceed-wrapper">
                                <div class="mc-message-head">Daily Limit Exceeded!</div>
                                <div class="mc-img"><img src="'.mycred_fortunewheel_PLUGIN_URL.'assets/img/mycred-sit.png" width="50"/></div>
                                <div class="mc-message">😯 Sorry Your Daily limit exceeded. Come back later for another spin.</div>
                            </div>' ),
