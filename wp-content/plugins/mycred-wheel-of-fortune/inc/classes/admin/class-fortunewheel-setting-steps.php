...
class Setting_Sections {
    ...
    function mycred_fortunewheel_step_meta( $post ) {
        ...
        echo '<div class="opt-steps">
            ...
            if( isset( $_GET['post'] ) ) {
                echo '<a href="'. admin_url( 'edit.php?post_type=fortunewheel-stats') .'&wheel_id='.get_the_ID().'" style="color:white"><div class="opt-step stats"><span>7</span> <div class="opt-text">View Stats <i class="fas fa-chart-pie"></i></div></div></a>';
            }
