...
//                $html .= $this->mycred_fortunewheel_initially_try_luck_btn();
    ...
    function mycred_fortunewheel_form_fields( $wheel_id ) {
        ...
        } else if( $fortunewheel_protect_post->mycred_fortunewheel_free_played($wheel_id) >= mycred_fortunewheel_get_post_meta( $wheel_id,'fortunewheel_free_attempts') ) {
            $html .= $fortunewheel_protect_post->mycred_fortunewheel_hide_complete_form();
    ...
    function mycred_fortunewheel_get_segments( $wheel_id ) {
        ...
        if( !empty($sections) ) {
            ...
            foreach( $sections as $section ) {
                ...
                $segments_each['mycred_point_types'] = $section['fortunewheel_mycred_types'];
