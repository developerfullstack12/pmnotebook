<?php
if ( ! class_exists( 'myCRED_Social_Proof_License' ) ) :
	final class myCRED_Social_Proof_License {

		// Plugin Version
		public $version = MYCRED_SP_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_SP_SLUG;

		public $base    = MYCRED_SP_THIS;
...
function mycred_social_proof_license() {
	return myCRED_Social_Proof_License::instance();
}
mycred_social_proof_license();