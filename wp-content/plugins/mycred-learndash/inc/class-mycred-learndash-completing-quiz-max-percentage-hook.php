...
function mycred_load_learndash_complete_quiz_max_percentage_hook() {
    ...
    if (!class_exists('myCRED_Hook_Learndash_Complete_Quiz_Max_Percentage') && class_exists('myCRED_Hook')) {
        ...
        class myCRED_Hook_Learndash_Complete_Quiz_Max_Percentage extends myCRED_Hook {
             ...
             */
            public function run() {
                add_action( 'learndash_quiz_completed', array($this,'mycred_ld_max_grade_complete_quiz'), 40, 2 );
            ...
            public function mycred_ld_max_grade_complete_quiz($quiz_data, $current_user) {
                ...
                $terms =  get_the_terms( $quiz_data['quiz']->ID, 'ld_quiz_tag');
                ...
                if(  isset($prefs['check_specific_hook']) && $prefs['check_specific_hook'] == '1' && !empty( $prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'] ) && in_array( $quiz_data['quiz']->ID, $prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'] )  ) {

                     $hook_index = array_search( $quiz_data['quiz']->ID, $prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'] );
                     ...
                     if (  
                        ...
                        if ( $this->core->has_entry( 'learndash_complete_quiz_max_percent_grade', $quiz_data['quiz']->ID, $current_user->ID) ) return;
                ...
                elseif ( isset($prefs['check_specific_hook']) && $prefs['check_specific_hook'] == '1' && !empty( $prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'] ) && in_array( 'tags' , $prefs['complete_quiz_max_percent_grade']['select_option'] ) && !empty( $prefs['complete_quiz_max_percent_grade']['creds'][$hook_index] ) ) {
                  ...
                  foreach ( $quiz_post as $quizzes ) {
                            if ( $quizzes->ID == $quiz_data['quiz']->ID && $score>= $prefs['complete_quiz_max_percent_grade']['max_percentage_grade'][$hook_index] && $quiz_data['pass'] ) {
                                 $this->core->add_creds(
                                'learndash_complete_quiz_max_percent_grade',
                                $current_user->ID,
                                $prefs['complete_quiz_max_percent_grade']['creds'][$hook_index],
                  ...
                  elseif ( isset($prefs['check_specific_hook']) && $prefs['check_specific_hook'] == '1' && !empty( $prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'] ) && in_array( 0 , $prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'] )  ) {
                       ...
                       if ( $hook_index === false ) {
                        ...
                        foreach ( $this->prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'] as $key => $value ) {
                            ...
                            if( $this->prefs['complete_quiz_max_percent_grade']['max_percent_select_quiz'][$key] == $quiz_data['quiz']->ID && $value == 0 ) {
                                $hook_index = $key;
                            }
                        }
                    }
              ...
              public function mycred_learndash_quiz_max_grade_arrange_data( $specific_quiz_max_percentage_hook_data ){
                ...
                foreach ( $specific_quiz_max_percentage_hook_data['creds'] as $key => $value ) {
                    ...
                    $hook_data[$key]['limit'] = $specific_quiz_max_percentage_hook_data['limit'][$key];
           ...
           public function preferences( ) {
                ...
                ?>
                 ...
                 <div class="hook-instance">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="<?php echo $this->field_id( 'maximum_grade_percentage' ); ?>"><?php _e('Maximum Percent', 'maximum_grade_percentage'); ?></label>
                ...
                <div class="quiz_max_grade_custom_hook_class">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  mycred-learndash-quiz-max-grade-options" id="user_selected" name="<?php echo $this->specific_field_name(array('complete_quiz_max_percent_grade' => 'select_option')); ?>" value=""  >
                                            <?php
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'User Option', 'max_percent_select_quiz' ); ?></label>
                                        <select class="form-control user_select_max_grade_quiz mycred-learndash-max-grade-quiz " id="selected_option"  name="<?php echo $this->specific_field_name(array('complete_quiz_max_percent_grade' => 'max_percent_select_quiz')); ?>" value=""  >
                                        ...
                                        if($label['select_option'] == 'quiz') {
                                            ...
                                            $quiz_id = $quiz_name->ID;
                                                echo '<option class="select-value" value="'.$quiz_name->ID.'" '. ( $quiz_name->ID == $label['max_percent_select_quiz'] ? ' selected' : '') .' >'.$quiz_name->post_title.'</option>';
                                            }
                                        }
                                        ...
                                        foreach($tags as $tag) {
                                            ...
                                            $quiz_maximum_percent_grade = $this->quiz_name();
                                             echo '<option class="select-value" value="'.$tag->term_id.'" '. ( $tag->term_id == $label['max_percent_select_quiz'] ? ' selected' : '') .' >'.$tag->name.'</option>'; 
                                        }
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="<?php echo $this->field_id(array('complete_quiz_max_percent_grade' => 'creds')); ?>"><?php echo $this->core->plural(); ?></label>
                                <input type="text" name="<?php echo $this->specific_field_name(array('complete_quiz_max_percent_grade' => 'creds')); ?>" id="<?php echo $this->field_id(array('complete_quiz_max_percent_grade' => 'creds')); ?>" value="<?php echo $this->core->number( $label['creds']); ?>" class="form-control mycred-learndash-max-grade-quiz-max-grade-creds" />
                            </div>
                        </div>
                         <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="<?php echo $this->field_id(array('complete_quiz_max_percent_grade' => 'max_percentage_grade')); ?>"><?php _e('Max Percent', 'max_percentage_grade'); ?></label>
                                        <input type="text" name="<?php echo $this->specific_field_name(array('complete_quiz_max_percent_grade' => 'max_percentage_grade')); ?>" id="<?php echo $this->field_id(array('complete_quiz_max_percent_grade' => 'max_percentage_grade')); ?>" value="<?php echo $this->core->number( $label['max_percentage_grade']); ?>" class="form-control mycred-learndash-creds" />       
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label style="margin-top:10px;" for="<?php echo $this->field_id(array('complete_quiz_max_percent_grade' => 'log')); ?>"><?php _e('Log Template', 'mycred'); ?></label>
                                <input type="text" name="<?php echo $this->specific_field_name(array('complete_quiz_max_percent_grade' => 'log')); ?>" id="<?php echo $this->field_id(array('complete_quiz_max_percent_grade' => 'log')); ?>" value="<?php echo esc_attr($label['log']) ; ?>" class="form-control mycred-learndash-quiz-max-grade-log" />
                                <span class="description"><?php echo $this->available_template_tags(array('general', 'post')); ?></span>
                            </div>
                        </div>
