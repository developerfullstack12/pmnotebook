    ...
    if (!class_exists('myCRED_Hook_Learndash_Quiz_Failed') && class_exists('myCRED_Hook')) {
        ...
        class myCRED_Hook_Learndash_Quiz_Failed extends myCRED_Hook {
            ...
            public function run() {
                ...
                add_action('learndash_quiz_completed', array($this, 'quiz_failed'), 80, 2);
            ...
            public function quiz_failed($quiz_data, $current_user) {
              ...
              $terms =  get_the_terms( $quiz_data['quiz']->ID, 'ld_quiz_tag');
               ...
               if(  isset($prefs['check_specific_hook']) && $prefs['check_specific_hook'] == '1' && !empty( $prefs['quiz_failed']['quiz_failed_select_quiz'] ) && in_array( $quiz_data['quiz']->ID, $prefs['quiz_failed']['quiz_failed_select_quiz'] )  ) {

                  $hook_index = array_search( $quiz_data['quiz']->ID, $prefs['quiz_failed']['quiz_failed_select_quiz'] );
                     ...
                     if (  
                        ...
                        if ( $this->core->has_entry( 'learndash_quiz_failed', $quiz_data['quiz']->ID, $current_user->ID) ) return;
                    ...
                    $hook_index = array_search( 0, $prefs['quiz_failed']['quiz_failed_select_quiz'] );
                       ...
                       if ( $hook_index === false ) {
                        ...
                        foreach ( $this->prefs['quiz_failed']['quiz_failed_select_quiz'] as $key => $value ) {
                            ...
                            if( $this->prefs['quiz_failed']['quiz_failed_select_quiz'][$key] == $quiz_data['quiz']->ID && $value == 0 ) {
                                $hook_index = $key;
                            }
                        }
                    }
        ...
        public function specific_field_name( $field = '' ) {
            ...
            public function mycred_learndash_quiz_failed_arrange_data( $specific_quiz_failed_hook_data ) {
                ...
                foreach ( $specific_quiz_failed_hook_data['creds'] as $key => $value ) {
                    ...
                    $hook_data[$key]['limit'] = $specific_quiz_failed_hook_data['limit'][$key];
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  mycred-learndash-quiz-fail-options" id="user_selected" name="<?php echo $this->specific_field_name(array('quiz_failed' => 'select_option')); ?>" value=""  >
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'User Option', 'quiz_failed_select_quiz' ); ?></label>
                                        <select class="form-control user_select_quiz_failed mycred-learndash-quiz-failed " id="selected_option"  name="<?php echo $this->specific_field_name(array('quiz_failed' => 'quiz_failed_select_quiz')); ?>" value=""  >
                                        ...
                                        if($label['select_option'] == 'quiz') {
                                            ...
                                            $quiz_id = $quiz_name->ID;
                                                ...
                                                echo '<option class="select-value" value="'.$quiz_name->ID.'" '. ( $quiz_name->ID == $label['quiz_failed_select_quiz'] ? ' selected' : '') .' >'.$quiz_name->post_title.'</option>';
                                            }
                                        ...
                                        foreach($tags as $tag) {
                                            ...
                                            $fail_quiz_field = $this->quiz_name();
                                             ...
                                             echo '<option class="select-value" value="'.$tag->term_id.'" '. ( $tag->term_id == $label['quiz_failed_select_quiz'] ? ' selected' : '') .' >'.$tag->name.'</option>';
                        ...
                        <div class="col-lg-3 col-md-2 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="<?php echo $this->specific_field_name(array('quiz_failed' => 'creds')); ?>" id="<?php echo $this->field_id(array('quiz_failed' => 'creds')); ?>" value="<?php echo $this->core->number( $label['creds']); ?>" class="form-control mycred-learndash-quiz-failed-creds" />
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="<?php echo $this->field_id(array('quiz_failed' => 'log')); ?>"><?php _e('Log Template', 'mycred'); ?></label>
                                <input type="text" name="<?php echo $this->specific_field_name(array('quiz_failed' => 'log')); ?>" id="<?php echo $this->field_id(array('quiz_failed' => 'log')); ?>" value="<?php echo esc_attr($label['log']) ; ?>" class="form-control mycred-learndash-quiz-failed-log" />
                                <span class="description"><?php echo $this->available_template_tags(array('general', 'post')); ?></span>
                            </div>
                        </div>
