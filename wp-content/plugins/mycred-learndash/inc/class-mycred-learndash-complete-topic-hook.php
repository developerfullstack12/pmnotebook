                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  mycred-learndash-topic-options" id="user_selected" name="<?php echo $this->specific_field_name(array('specific_topic_completed' => 'select_option')); ?>" value=""  >
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'User Selected Option', 'select_topic' ); ?></label>
                                        <select class="form-control user_select_topic " id="selected_option"  name="<?php echo $this->specific_field_name(array('specific_topic_completed' => 'select_topic')); ?>" value=""  >
                                        ...
                                        if($label['select_option'] == 'topic') {
                                            ...
                                            $topic_id = $topic_name->ID;
                                                ...
                                                echo '<option class="select-value" value="'.$topic_name->ID.'" '. ( $topic_name->ID == $label['select_topic'] ? ' selected' : '') .' >'.$topic_name->post_title.'</option>';
                                            }
                                        ...
                                        foreach($tags as $tag) {
                                            ...
                                            $topic_field = $this->topic_name();
                                             ...
                                             echo '<option class="select-value" value="'.$tag->term_id.'" '. ( $tag->term_id == $label['select_topic'] ? ' selected' : '') .' >'.$tag->name.'</option>';
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="<?php echo $this->field_id(array('specific_topic_completed' => 'creds')); ?>"><?php echo $this->core->plural(); ?></label>
                                        <input type="text" name="<?php echo $this->specific_field_name(array('specific_topic_completed' => 'creds')); ?>" id="<?php echo $this->field_id(array('specific_topic_completed' => 'creds')); ?>" value="<?php echo $this->core->number( $label['creds']); ?>" class="form-control mycred-learndash-topic-creds" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="<?php echo $this->field_id(array('specific_topic_completed' => 'log')); ?>"><?php _e('Log Template', 'mycred'); ?></label>
                                        <input type="text" name="<?php echo $this->specific_field_name(array('specific_topic_completed' => 'log')); ?>" id="<?php echo $this->field_id(array('specific_topic_completed' => 'log')); ?>" value="<?php echo esc_attr($label['log']) ; ?>" class="form-control mycred-learndash-topic-log" />
                                        <span class="description"><?php echo $this->available_template_tags(array('general', 'post')); ?></span>
                                    </div>
                                </div>
