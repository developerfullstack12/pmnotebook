...
class MyCred_LearnDash_Settings {
    ...
    public function admin_notices() {
        echo '<div class="error"><p>' . __('LearnDash plugin is required to activate MyCred LearnDash add-on plugin. Please activate it first.', 'mycred') . '</p></div>';
    }
    ...
    public function mycred_settings_page() {
        ...
        ?>
        <div class="wrap">
            <h2 class="learndash-mycred-settings-header"><?php _e('MyCred Settings', 'learndash-mycred'); ?></h2>
                ...
                <div class="sfwd_options_wrapper sfwd_settings_left">
                    <div id="advanced-sortables" class="meta-box-sortables">
                        <div id="sfwd-courses_metabox" class="postbox learndash-mycred-settings-postbox">
                            <div class="handlediv" title="<?php _e('Click to toggle', 'learndash-mycred'); ?>"><br></div>
                            <div class="inside">
                                ...
                                <div class="custom-option">
                                    <label>
                                        <img class="help-button" alt=""
                                             src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                                             <?php echo __('Allow using myCred points in buying courses', 'learndash-mycred'); ?>
                                    </label>
                                    <div class="option-wrapper">
                                        <div class="form-element two-cols">
                                            <input id="allow_buy_course_pts" type="checkbox" name="allow_buy_course_pts" value="1"
                                                   <?php echo get_option('allow_buy_course_pts') ? "checked" : "" ?>> <?php echo __('Yes', 'learndash-mycred'); ?>
                                        </div>
                                ...
                                <div class="custom-option">
                                    <label>
                                        <img class="help-button" alt=""
                                             src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                                             <?php echo __('Allow creating leaderboards based on myCred points ?', 'learndash-mycred'); ?>
                                    </label>
                                    <div class="option-wrapper">
                                        <div class="form-element two-cols">
                                            <input id="learndash_allow_leaderboard" type="checkbox" name="learndash_allow_leaderboard"
                                                   value="1"
                                                   <?php echo get_option('learndash_allow_leaderboard') ? "checked" : "" ?>> <?php echo __('Yes', 'learndash-mycred'); ?>
                                        </div>
        ...
        if (mycred_get_types()) {
            ...
            <div class="custom-option" id="pt-type-exchange">
                <label>
                    <img class="help-button" alt=""
                         src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                         <?php echo __('Exchange Rate for points types', 'learndash-mycred'); ?>
                </label>
                <div class="option-wrapper">
                    <div class="form-element two-cols">
                        <select name="learndash_point_type">
                            <?php foreach (mycred_get_types() as $k => $value) { ?>
                                <option value="<?php echo $k ?>" <?php echo $pt_type == $k ? 'selected' : '' ?>><?php echo $value ?></option>
                            <?php } ?>
                        </select>
                        <input type="text" name="learndash_mycred_exchange_rate" value="<?php echo $rate; ?>"
                               class="regular-text"><?php echo '$' ?>
                    </div>
                    <div class="help-text"><?php echo __('Enter exchange rate to convert currency into points', 'learndash-mycred') ?></div>
