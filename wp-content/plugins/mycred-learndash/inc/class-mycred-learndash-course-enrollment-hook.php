            ...
            public function enroll_course_field_name( $field = '' ) {
             ...
             public function mycred_learndash_arrange_data( $specific_enroll_course_hook_data){
                ...
                foreach ( $specific_enroll_course_hook_data['creds'] as $key => $value ) {
                    ...
                    $hook_data[$key]['limit'] = $specific_enroll_course_hook_data['limit'][$key];
                ...
                <div class="hook-instance" id="specific-hook">
                        ...
                        <div class="course_custom_hook_class">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="<?php echo $this->field_id(array('course_enrollment' => 'creds')); ?>"><?php echo $this->core->plural(); ?></label>
                                        <input type="text" name="<?php echo $this->enroll_course_field_name(array('course_enrollment' => 'creds')); ?>" id="<?php echo $this->field_id(array('course_enrollment' => 'creds')); ?>" value="<?php echo $this->core->number( $label['creds']); ?>" class="form-control mycred-learndash-course-creds" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'Select Specific Course', 'course_enrollment_select_course' ); ?></label>
                                        <select class="form-control mycred-learndash-course " name="<?php echo $this->enroll_course_field_name(array('course_enrollment' => 'course_enrollment_select_course')); ?>" value=""  >
                                        ...
                                        $course_id = $course_name->ID;
                                            ...
                                            echo '<option class="select-value" value="'.$course_name->ID.'" '. ( $course_name->ID == $label['course_enrollment_select_course'] ? ' selected' : '') .' >'.$course_name->post_title.'</option>';
                                        }
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="<?php echo $this->field_id(array('course_enrollment' => 'log')); ?>"><?php _e('Log Template', 'mycred'); ?></label>
                                        <input type="text" name="<?php echo $this->enroll_course_field_name(array('course_enrollment' => 'log')); ?>" id="<?php echo $this->field_id(array('course_enrollment' => 'log')); ?>" value="<?php echo esc_attr($label['log']) ; ?>" class="form-control mycred-learndash-course-log" />
                                        <span class="description"><?php echo $this->available_template_tags(array('general', 'post')); ?></span>
                                    </div>
                                </div>
