    ...
    <div class="sfwd sfwd_options">
        ...
        <?php if (get_post_type() == 'sfwd-quiz'): 
            ...
            <div id="max_percentage_field" class="sfwd_input sfwd_input_type_text">
                <span class="sfwd_option_label">
                    <a class="sfwd_help_text_link">
                        <label for="min_percentage_input" class="sfwd_label"><?php _e("Maximum percentage", "mycred-learndash"); ?></label>
                    </a>
                </span>
                <span class="sfwd_option_input">
                    <div class="sfwd_option_div">
                    <input autocomplete="off" id="max_percentage_input" type="text" name="max_percentage" class="learndash-section-field learndash-section-field-text -medium" value="<?php echo $max_percentage ?>"> %  
                    </div>
                </span>
                <p class="ld-clear"></p>
            </div>
