        ...
        class myCRED_Hook_Learndash_Join_Group extends myCRED_Hook {
            ...
            public function mycred_learndash_arrange_data( $specific_join_group_hook_data){
                ...
                foreach ( $specific_join_group_hook_data['creds'] as $key => $value ) {
                    ...
                    $hook_data[$key]['limit'] = $specific_join_group_hook_data['limit'][$key];
                ...
                <div class="group-hook-instance" id="specific-hook">
                        ...
                        <div class="group_custom_hook_class">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="<?php echo $this->field_id(array('join_group' => 'creds')); ?>"><?php echo $this->core->plural(); ?></label>
                                        <input type="text" name="<?php echo $this->join_group_field_name(array('join_group' => 'creds')); ?>" id="<?php echo $this->field_id(array('join_group' => 'creds')); ?>" value="<?php echo $this->core->number( $label['creds']); ?>" class="form-control mycred-learndash-group-creds" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'Select Specific Group', 'join_group_select_group' ); ?></label>
                                        <select class="form-control mycred-learndash-group " name="<?php echo $this->join_group_field_name(array('join_group' => 'join_group_select_group')); ?>" value=""  >
                                        ...
                                        $group_id = $group_name->ID;
                                            ...
                                            echo '<option class="select-value" value="'.$group_name->ID.'" '. ( $group_name->ID == $label['join_group_select_group'] ? ' selected' : '') .' >'.$group_name->post_title.'</option>';
                                        }
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="<?php echo $this->field_id(array('join_group' => 'log')); ?>"><?php _e('Log Template', 'mycred'); ?></label>
                                        <input type="text" name="<?php echo $this->join_group_field_name(array('join_group' => 'log')); ?>" id="<?php echo $this->field_id(array('join_group' => 'log')); ?>" value="<?php echo esc_attr($label['log']) ; ?>" class="form-control mycred-learndash-group-log" />
                                        <span class="description"><?php echo $this->available_template_tags(array('general', 'post')); ?></span>
                                    </div>
                                </div>
