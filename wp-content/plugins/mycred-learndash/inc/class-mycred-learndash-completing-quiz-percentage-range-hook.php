    ...
    if (!class_exists('myCRED_Hook_Learndash_Complete_Quiz_Percentage_Range') && class_exists('myCRED_Hook')) {
        ...
        class myCRED_Hook_Learndash_Complete_Quiz_Percentage_Range extends myCRED_Hook {  
            ...
            public function mycred_ld_complete_quiz_between_grade_range($quiz_data, $current_user){
              ...
              if(  isset($prefs['check_specific_hook']) && $prefs['check_specific_hook'] == '1' && !empty( $prefs['quiz_range_percent_grade']['range_select_quiz'] ) && in_array( $quiz_data['quiz']->ID, $prefs['quiz_range_percent_grade']['range_select_quiz'] )  ) {
                 ...
                 elseif ( isset($prefs['check_specific_hook']) && $prefs['check_specific_hook'] == '1' && !empty( $prefs['quiz_range_percent_grade']['range_select_quiz'] ) && in_array( 'tags' , $prefs['quiz_range_percent_grade']['select_option'] ) && !empty( $prefs['quiz_range_percent_grade']['creds'][$hook_index] ) && $quiz_data['pass'] ) {
                    ...
                    foreach ( $quiz_post as $quizzes ) {
                            if ( $quizzes->ID == $quiz_data['quiz']->ID && $score>= $prefs['quiz_range_percent_grade']['min_percentage_range'][$hook_index] && $score<= $prefs['quiz_range_percent_grade']['max_percentage_range'][$hook_index] && $quiz_data['pass'] ) {
                                 $this->core->add_creds(
                                'learndash_quiz_range_percent_grade',
                                $current_user->ID,
                                $prefs['quiz_range_percent_grade']['creds'][$hook_index],
                     ...
                     $hook_index = array_search( 0, $prefs['quiz_range_percent_grade']['range_select_quiz'] );
                       ...
                       if ( $hook_index === false ) {
                        ...
                        foreach ( $this->prefs['quiz_range_percent_grade']['range_select_quiz'] as $key => $value ) {
                            ...
                            if( $this->prefs['quiz_range_percent_grade']['range_select_quiz'][$key] == $quiz_data['quiz']->ID && $value == 0 ) {
                                $hook_index = $key;
                            }
                        }
                    }
                ...
                ?>
                 ...
                 <div class="hook-instance">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="<?php echo $this->field_id( 'minimum_grade_percentage' ); ?>"><?php _e('Minimum Percent', 'minimum_grade_percentage'); ?></label>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  mycred-learndash-quiz-percent-grade-options" id="user_selected" name="<?php echo $this->specific_field_name(array('quiz_range_percent_grade' => 'select_option')); ?>" value=""  >
                                            <?php
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'User Option', 'range_select_quiz' ); ?></label>
                                        <select class="form-control user_select_percent_grade_quiz mycred-learndash-percent-grade-quiz " id="selected_option"  name="<?php echo $this->specific_field_name(array('quiz_range_percent_grade' => 'range_select_quiz')); ?>" value=""  >
                                        ...
                                        foreach($tags as $tag) {
                                            $quiz_percent_grade_range = $this->quiz_name();
                                             echo '<option class="select-value" value="'.$tag->term_id.'" '. ( $tag->term_id == $label['range_select_quiz'] ? ' selected' : '') .' >'.$tag->name.'</option>';   
                                        }
                                    }   
                                        ?>  
                                        </select>   
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="<?php echo $this->specific_field_name(array('quiz_range_percent_grade' => 'creds')); ?>" id="<?php echo $this->field_id(array('quiz_range_percent_grade' => 'creds')); ?>" value="<?php echo $this->core->number( $label['creds']); ?>" class="form-control mycred-learndash-percent-grade-quiz-percent-grade-creds" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="<?php echo $this->field_id(array('quiz_range_percent_grade' => 'min_percentage_range')); ?>"><?php _e('Min Percent', 'min_percentage_range'); ?></label>
                                        <input type="text" name="<?php echo $this->specific_field_name(array('quiz_range_percent_grade' => 'min_percentage_range')); ?>" id="<?php echo $this->field_id(array('quiz_range_percent_grade' => 'min_percentage_range')); ?>" value="<?php echo $this->core->number( $label['min_percentage_range']); ?>" class="form-control mycred-learndash-min-grade-quiz-min-grade-creds" />  
                            </div>
                        </div>
                         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label  for="<?php echo $this->field_id(array('quiz_range_percent_grade' => 'max_percentage_range')); ?>"><?php _e('Max Percent', 'max_percentage_range'); ?></label>
                                        <input type="text" name="<?php echo $this->specific_field_name(array('quiz_range_percent_grade' => 'max_percentage_range')); ?>" id="<?php echo $this->field_id(array('quiz_range_percent_grade' => 'max_percentage_range')); ?>" value="<?php echo $this->core->number( $label['max_percentage_range']); ?>" class="form-control mycred-learndash-max-grade-quiz-max-grade-creds" />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="<?php echo $this->field_id(array('quiz_range_percent_grade' => 'log')); ?>"><?php _e('Log Template', 'mycred'); ?></label>
                                    <input type="text" name="<?php echo $this->specific_field_name(array('quiz_range_percent_grade' => 'log')); ?>" id="<?php echo $this->field_id(array('quiz_range_percent_grade' => 'log')); ?>" value="<?php echo esc_attr($label['log']) ; ?>" class="form-control mycred-learndash-quiz-percent-grade-log" />
                                    <span class="description"><?php echo $this->available_template_tags(array('general', 'post')); ?></span>
                                </div>
                            </div>
                        </div>
