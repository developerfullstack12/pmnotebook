...
class MyCred_Learndash_Leaderboard {
    ...
    public function mycred_learndash_leaderboard_mb($post) {
        ...
        echo '<input type="hidden" name="mycred_leaderboard_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
        ?>
        <div class="custom-option">
            <label>
                <img class="help-button" alt="" src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                <?php _e('Create Leaderboard of ', 'mycred-learndash'); ?> </label>
            <div class="option-wrapper">
                <div class="form-element">
                    <select name="leaderboard_setting[leaderboard_type]" id="leaderboard_type"
                        ...
                        <option value="course" <?php echo $type == 'course' ? 'selected' : '' ?>>
                            <?php _e('Courses', 'mycred'); ?></option>
                        <option value="lesson" <?php echo $type == 'lesson' ? 'selected' : '' ?>>
                            <?php _e('Lessons', 'mycred'); ?></option>
                        <option value="topic" <?php echo $type == 'topic' ? 'selected' : '' ?>><?php _e('Topics', 'mycred'); ?>
                        </option>
                        <option value="quiz" <?php echo $type == 'quiz' ? 'selected' : '' ?>><?php _e('Quizes', 'mycred'); ?>
                        </option>
                    </select>
                </div>
                ...
                <div id="based_on_lesson" class="based-option">
                    <?php echo $this->mycred_leaderboard_associated_course('lesson'); ?>
                </div>

                <div id="based_on_topic" class="based-option">
                    <?php echo $this->mycred_leaderboard_associated_course('topic'); ?>
                </div>

                <div id="based_on_quiz" class="based-option">
                    <?php echo $this->mycred_leaderboard_associated_course('quiz'); ?>
                </div>
        ...
        <?php
        echo $this->leaderboard_other_settings($post, $default);
    }

    public function mycred_learndash_course_options() {
        $post_id = absint($_POST['leaderboard_id']);
        ...
        <div id="leaderboard_based_on_course">
            <label class="based-title"><?php _e('Create Leaderboard based on ', 'mycred-learndash'); ?></label>
            ...
            <div>
                ...
                <label for="course_category"><?php _e('Course Category', 'mycred-learndash'); ?></label>
            </div>
            ...
            <div>
                ...
                <label for="specific_course"><?php _e('Specific Course(s)', 'mycred-learndash'); ?></label>
            </div>

            <div>
                <input type="checkbox" id="all_courses" value="all" class="all" name="leaderboard_course_based[all]"
                       <?php checked($select_all, 'all'); ?> />
                <label for="all_courses"><?php _e('Select All', 'mycred-learndash'); ?></label>
            </div>
                     ...
                     if ($courses_ids) {
                         ...
                         if ($course_cat_terms) {
                            ...
                            <label class="label-text"><input type="checkbox" name="leaderboard_course_based[leaderboard_taxonomy][]"
                                                             <?php echo $checked; ?> value="<?php echo $cat_id ?>" /><?php echo $course_cat_term; ?></label>
                                <?php
                            }
                        }
                    } else {
                 ...
                 style="<?php echo $based_course != 'specific_course' ? 'display: none;' : 'display:flex;' ?>">
                     ...
                     if ($courses_ids) {
                        ...
                        <label class="label-text"><input type="checkbox" name="leaderboard_course_based[leaderboard_posts][]"
                            <?php echo $checked ?>
                                                         value="<?php echo $courses_id ?>" /><?php echo get_the_title($courses_id) ?></label>
                            <?php
                        }
                    } else {
    ...
    public function mycred_leaderboard_associated_course($type) {
        ...
        if ($type == 'lesson') {
            if ($lwms->select_a_course(('sfwd-lessons'))) {
                ?>
                <label class="based-title"><?php _e('Associated Course', 'mycred-learndash'); ?></label>
                <select name="leaderboard_lesson_based[leaderboard_associated_course_lesson]" id="leaderboard_associated_course">
                    <?php foreach ($lwms->select_a_course('sfwd-lessons') as $k => $value) { ?>
                        <option value="<?php echo $k; ?>" <?php echo $course_id == $k ? "selected" : "" ?>><?php echo $value; ?></option>
                        <?php
                    }
                    ?>
                </select>
            ...
            if ($lwms->select_a_course('sfwd-topic')) {
                ...
                <select name="leaderboard_topic_based[leaderboard_associated_course_topic]" id="leaderboard_associated_course_topic"
                        ...
                        <option value="<?php echo $k; ?>" <?php echo $course_id_topic == $k ? "selected" : "" ?>><?php echo $value; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            if ($lwms->select_a_course('sfwd-quiz')) {
                ...
                <select name="leaderboard_quiz_based[leaderboard_associated_course_quiz]" id="leaderboard_associated_course_quiz"
                        ...
                        <option value="<?php echo $k; ?>" <?php echo $course_id_quiz == $k ? "selected" : "" ?>><?php echo $value; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
    ...
    function mycred_learndash_select_a_course_ajax() {
        $this->mycred_leaderboard_based_lesson(absint($_POST['leaderboard_id']), absint($_POST['course_id']));
        die;
    }
    ...
    public function mycred_leaderboard_based_lesson($post_id, $course_id) {
        ...
        <div id="leaderboard_based_on_lessons">
            ...
            <div>
                ...
                <label for="lesson_category"><?php _e('Lesson Category', 'mycred-learndash'); ?></label>
            </div>
            ...
            <div>
                ...
                <label for="specific_lesson"><?php _e('Specific Lesson(s)', 'mycred-learndash'); ?></label>
            </div>

            <div>
                <input type="checkbox" id="all_lessons" class="all" value="all" name="leaderboard_lesson_based[all]"
                       <?php echo $select_all == 'all' ? 'checked' : '' ?> />
                <label for="all_lessons"><?php _e('Select All', 'mycred-learndash'); ?></label>
            </div>
        </div>
                 ...
                 if ($lesson_ids) {
                     ...
                     if ($lesson_cats) {
                         foreach (array_unique($lesson_cats) as $term_id => $lesson_category) {
                             ...
                             ?>
                        <label class="label-text"><input type="checkbox" value="<?php echo $term_id ?>" <?php echo $checked; ?>
                                                         name="leaderboard_lesson_based[leaderboard_course_lesson_cat][]" /><?php echo $lesson_category; ?></label>
                            <?php
                        }
                    } else {
                        echo '<span class="no-lesson">No Category</span>';
             ...
             style="<?php echo $based_lesson != 'specific_lesson' ? 'display: none;' : 'display:flex;' ?>">
                 ...
                 if ($lesson_ids) {
                     ...
                     foreach ($lesson_ids as $lesson_id) {
                         ...
                         ?>
                    <label class="label-text"><input type="checkbox" value="<?php echo $lesson_id ?>" <?php echo $checked; ?>
                                                     name="leaderboard_lesson_based[leaderboard_lessons][]" /><?php echo get_the_title($lesson_id); ?></label>
                        <?php
                    }
                } else {
    ...
    function mycred_learndash_select_a_lesson_ajax() {
        $lwms = new SFWD_LMS();
        $post_array = $lwms->select_a_lesson(absint($_POST['course_id']));
        $lesson_meta = get_post_meta(absint($_POST['leaderboard_id']), 'leaderboard_topic_based', true);
        $learndash_lesson = $lesson_meta['learndash_lesson'];
        if ($post_array) {
            ?>
            <label class="based-title"><?php _e('Associated Lesson', 'mycred-learndash'); ?></label>
            <select name="leaderboard_topic_based[learndash_lesson]" id="learndash_lesson">
                <?php foreach ($post_array as $k => $value): ?>
                    <option value="<?php echo $k ?>" <?php echo $learndash_lesson == $k ? "selected" : "" ?>><?php echo $value; ?>
                    </option>
                <?php endforeach; ?>
            </select>
            <?php
    ...
    function mycred_learndash_select_a_quiz_ajax() {
        $lwms = new SFWD_LMS();
        $lessons_topics = $lwms->select_a_lesson_or_topic(absint($_POST['course_id']));
        $lesson_topic_meta = get_post_meta(absint($_POST['leaderboard_id']), 'leaderboard_quiz_based', true);
        $learndash_topic_quiz = $lesson_topic_meta['learndash_lesson_topic'];
        if ($lessons_topics) {
            ?>
            <label class="based-title"><?php _e('Associated Lesson or topic', ''); ?></label>
            <select name="leaderboard_quiz_based[learndash_lesson_topic]" id="learndash_lesson_topic">
                <?php foreach ($lessons_topics as $k => $value): ?>
                    <option value="<?php echo $k ?>" <?php echo $learndash_topic_quiz == $k ? "selected" : "" ?>><?php echo $value; ?>
                    </option>
                <?php endforeach; ?>
            </select>
    ...
    public function mycred_leaderboard_based_topic() {
        $topic_based = get_post_meta(absint($_POST['leaderboard_id']), 'leaderboard_topic_based', true);
        ...
        $opt = array(
            ...
            'meta_query' => array(
                ...
                array(
                    'key' => 'course_id',
                    'value' => absint($_POST['course_id']),
                    'compare' => '==',
                ),
                array(
                    'key' => 'lesson_id',
                    'value' => absint($_POST['lesson_id']),
                    'compare' => '==',
                ),
            )
        );
        ...
        <div id="leaderboard_based_on_topics">
            ...
            <div>
                ...
                <label for="topic_category"><?php _e('Topic Category', 'mycred'); ?></label>
            </div>
            ...
            <div>
                ...
                <label for="specific_topic"><?php _e('Specific Topic(s)', 'mycred-learndash'); ?></label>
            </div>

            <div>
                <input type="checkbox" id="all_topics" class="all" value="all" name="leaderboard_topic_based[all]"
                       <?php echo $select_all == 'all' ? 'checked' : '' ?> />
                <label for="all_topics"><?php _e('Select All', 'mycred-learndash'); ?></label>
            </div>
                     ...
                     if ($topic_ids) {
                         ...
                         if ($topic_cats) {
                            ...
                            <label class="label-text"><input type="checkbox" name="leaderboard_topic_based[leaderboard_select_topic_cat][]"
                                                             <?php echo $checked; ?> value="<?php echo $term_id ?>" /><?php echo $term_name ?></label>
                 ...
                 style="<?php echo $based_topic != 'specific_topic' ? 'display: none;' : 'display:flex;' ?>">
                     ...
                     if ($topic_ids) {
                         foreach ($topic_ids as $topic_id):
                             ...
                             ?>
                        <label class="label-text"><input type="checkbox" value="<?php echo $topic_id ?>" <?php echo $checked; ?>
                                                         name="leaderboard_topic_based[leaderboard_select_topic][]" /><?php echo get_the_title($topic_id); ?></label>
                            <?php
                        endforeach;
                    } else {
    ...
    public function mycred_learndash_show_based_quiz() {
        $quiz_based = get_post_meta(absint($_POST['leaderboard_id']), 'leaderboard_quiz_based', true);
        ...
        <div id="leaderboard_based_on_quizes">
            ...
            <div>
                ...
                <label for="quiz_category"><?php _e('Quiz Category', 'mycred-learndash'); ?></label>
            </div>
            ...
            <div>
                ...
                <label for="specific_quiz"><?php _e('Specific Quiz(es)', 'mycred-learndash'); ?></label>
            </div>

            <div>
                <input type="checkbox" id="all_quizes" class="all" value="all" name="leaderboard_quiz_based[all]"
                       <?php echo $select_all == 'all' ? 'checked' : '' ?> />
                <label for="all_quizes"><?php _e('Select All', 'mycred-learndash'); ?></label>
            </div>
                         ...
                         if ($quiz_cats) {
                            ...
                            <div>
                                <label class="label-text"><input type="checkbox"
                                                                 name="leaderboard_quiz_based[leaderboard_select_quiz_cat][]" <?php echo $checked; ?>
                                                                 value="<?php echo $term_id ?>" /><?php echo $term_name ?></label>
                            </div>
                 ...
                 style="<?php echo $based_quiz != 'specific_quiz' ? 'display: none;' : 'display:flex;' ?>">
                     ...
                     if ($quiz_ids) {
                         foreach ($quiz_ids as $quiz_id):
                             ...
                             ?>
                        <label class="label-text"><input type="checkbox" value="<?php echo $quiz_id ?>"
                                                         name="leaderboard_quiz_based[leaderboard_select_quiz][]"
                                                         <?php echo $checked; ?> /><?php echo get_the_title($quiz_id); ?></label>
                            <?php
                        endforeach;
                    } else {
    ...
    public function mycred_learndash_leaderboard_save( $post_id, $post, $update ) {
        ...
        if ( !wp_verify_nonce( $_POST['mycred_leaderboard_box_nonce'], basename(__FILE__) ) ) return $post_id;

        if ( isset( $_POST['leaderboard_setting'] ) ) {
            
            $leaderboard_setting = array();
            
            foreach ( $_POST['leaderboard_setting'] as $key => $value ) {
                if ( 
        ...
        if ( isset( $_POST['leaderboard_course_based'] ) ) {
            ...
            foreach ( $_POST['leaderboard_course_based'] as $key => $value ) {
                if ( ! is_array( $value ) ) {
        ...
        if ( isset( $_POST['leaderboard_topic_based'] ) ) {
            ...
            foreach ( $_POST['leaderboard_topic_based'] as $key => $value ) {
                if ( ! is_array( $value ) ) {
        ...
        if ( isset( $_POST['leaderboard_quiz_based'] ) ) {
            ...
            foreach ( $_POST['leaderboard_quiz_based'] as $key => $value ) {
                if ( ! is_array( $value ) ) {
        ...
        if ( isset( $_POST['leaderboard_lesson_based'] ) ) {
            ...
            foreach ( $_POST['leaderboard_lesson_based'] as $key => $value ) {
                if ( ! is_array( $value ) ) {
    ...
    public function leaderboard_other_settings($post, $default) {?>
        <div class="leaderboard-settings">
            <div class="custom-option">
                <label>
                    <img class="help-button" alt="" src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                    <?php _e('Leaderboard for which point type?', 'mycred-learndash'); ?></label>
                <div class="option-wrapper">
                    <div class="form-element">
            ...
            <div>
                <div class="custom-option">
                    <label>
                        <img class="help-button" alt="" src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                        <?php _e('Timing Filter of Leaderboard', 'mycred-learndash'); ?>
                    </label>
                    <div class="option-wrapper">
                        <div class="form-element">
                            <div class="timing-wrapper">
                                ...
                                <div id="custom-picker">
                                    <label for="from">From</label> <input type="text" id="from"
                                                                          ...
                                                                          value="<?php echo $custom_date[0]; ?>" />
                                    <label for="to">to</label> <input type="text" id="to"
                                                                      name="leaderboard_setting[mycred_leaderboard_custom_date][]"
                                                                      value="<?php echo $custom_date[1]; ?>" />
                                </div>
                            </div>
                        </div>
            ...
            if (count(get_users()) >= 1) :
                ...
                <div class="custom-option">
                    <label>
                        <img class="help-button" alt="" src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                             <?php _e('Show Top', 'mycred-learndash'); ?>
                    </label>
                        ...
                        <div class="form-element">
                            <div class="user-count">
                                <input type="number" name="leaderboard_setting[leaderboard_users]"
                                       value="<?php echo $default['leaderboard_users'] ? $default['leaderboard_users'] : 10; ?>" /><?php _e('Users', 'mycred-learndash'); ?>
                            </div>
                        </div>
            ...
            <div class="custom-option">
                <label>
                    <img class="help-button" alt="" src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                         <?php _e('Show Pagination', 'mycred-learndash'); ?>
                </label>
                    ...
                    <div class="form-element">
                        <div class="show-pag">
                            <input type="checkbox" value="1" id="show-pagination" name="leaderboard_setting[leaderboard_pagination]"
                                   <?php echo $default['leaderboard_pagination'] ? 'checked' : '' ?> /><?php _e('Yes', 'mycred-learndash'); ?>
                            <div id="pagination-number">
                                <input type="number" name="leaderboard_setting[leaderboard_pagination_value]"
                                       value="<?php echo $default['leaderboard_pagination_value']; ?>" /><?php _e('Users per page', ',mycred-learndash'); ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="custom-option">
                <label>
                    <img class="help-button" alt="" src="<?php echo plugin_dir_url(__FILE__) . '/assets/images/question.png'; ?>">
                         <?php _e('Shortcode', 'mycred-learndash'); ?>
                </label>

                <div class="option-wrapper">
                    <div class="form-element">
                        <input type="text" size="100" readonly
                               value="<?php echo get_post_meta(get_the_ID(), 'leaderboard_shortcode', true); ?>"
